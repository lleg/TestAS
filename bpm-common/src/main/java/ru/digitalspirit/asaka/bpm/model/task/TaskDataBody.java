 ...
 */
public class TaskDataBody extends RestEntity {

	//A string which represent the result obtained from evaluating a javascript expression within the context of a currently running ru.digitalspirit.nbu.ws.service.
