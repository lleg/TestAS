...
import ru.digitalspirit.asaka.bpm.model.process.definition.Diagram;
...
public class ProcessDetailsBody extends RestEntity {
	
	private static final List<TaskDetailsBody> EMPTY_TASKS = Lists.newArrayList();
	...
	//Excution tree associated with the process.
	...
	private List<TaskDetailsBody> tasks;
	...
	/**
	 * @return Excution tree associated with the process.
	 */
	 ...
	 */
	public List<TaskDetailsBody> getTasks() {
	...
	public void setTasks(List<TaskDetailsBody> tasks) {
		this.tasks = tasks;
	}
