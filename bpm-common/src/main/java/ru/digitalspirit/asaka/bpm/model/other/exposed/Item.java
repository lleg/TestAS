...
public class Item extends RestEntity {
	...
	//The subtype associated with the exposed item of type 'ru.digitalspirit.nbu.ws.service': 'not_exposed', 'administration_service', 'startable_service', 'dashboard', or 'url'.
	...
	/**
	 * @return The subtype associated with the exposed item of type 'ru.digitalspirit.nbu.ws.service': 'not_exposed', 'administration_service', 'startable_service', 'dashboard', or 'url'.
	 */
