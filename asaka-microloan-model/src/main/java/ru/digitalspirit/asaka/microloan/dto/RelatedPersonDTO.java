 ...
 */
@ApiModel("Связанное лицо (microzime)")
@ToString
public class RelatedPersonDTO {
	...
	private List<AddressTypeDTO> AddressList;
	...
	@JsonProperty("TrusteeStatus")
	@ApiModelProperty("Отношение к клиенту")
	...
	@JsonProperty("Sex")
	@ApiModelProperty("Сфера деятельности")
	...
	public List<AddressTypeDTO> getAddressList() {
		return AddressList;
	}

	public void setAddressList(List<AddressTypeDTO> AddressList) {
		this.AddressList = AddressList;
	}

	@JsonProperty("RegAddrEqualsResAddr")
	...
	public void setRegAddrEqualsResAddr(Boolean RegAddrEqualsResAddr) {
		this.RegAddrEqualsResAddr = RegAddrEqualsResAddr;
	}
	...
	@JsonProperty("NinpsAccountBank")
	@ApiModelProperty("Банк в котором открыт счет НИНПС открыт")
	public String getNinpsAccountBank() {
		return NinpsAccountBank;
	}

	public void setNinpsAccountBank(String NinpsAccountBank) {
		this.NinpsAccountBank = NinpsAccountBank;
	}
